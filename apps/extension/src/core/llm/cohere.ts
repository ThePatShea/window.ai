  ...
  return new Model(
    {
      ...
      promptCost: 0, // TODO: Replace this with the correct price per token for cohere
      completionCost: 0, // TODO: Replace this with the correct price per token for cohere
      getPath: () => "/generate",
      authPrefix: "BEARER ",
